                ...
                <div class="form-group d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column ms-2">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="privacyDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span id="tag">Public</span>
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="privacyDropdown">
                                    <li><a class="dropdown-item" href="#" onclick="updateTag('Public')">Public</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="updateTag('Private')">Private</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
